...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lista_favoritos` AS select `eventos`.`codevento` AS `codigo`,`eventos`.`nomeevento` AS `nome`,`eventos`.`descevento` AS `descricao`,`eventos`.`imgevento` AS `imagem` from `eventos` where `eventos`.`codevento` in (select `favoritos`.`codevento` from `favoritos`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-06-27 20:18:19
